...
mylauncher = awful.widget.launcher({ image ="/home/nico/.config/awesome/icons/peace.png", 
                                     menu = mymainmenu })
...
local widgets = require("vicious")
vicious = require("vicious")

local todo_widget = require("awesome-wm-widgets.todo-widget.todo")
mytextclock = wibox.widget.textclock(l)
--Network widget-----------------------------
netwidget = wibox.widget.textbox()
vicious.register(netwidget, 
vicious.widgets.net,
'<span background="#7e5edc" font="Terminus 12"> <span font="Terminus 9" color="#FFFFFF">${wlan0 down_kb} ↓↑ ${wlan0 up_kb} </span> </span>', 3)
...
globalkeys = gears.table.join(
	...
	awful.key({modkey,"Shift"},"+", function ()
		awful.spawn("/home/nico/.scripts/screen.sh")
	end, {description="Search for next Screen",group="Tools"}),
	awful.key({modkey},"F12", function ()
		awful.spawn("escrotum -C")
	end, {description="Screenshot clipboard",group="Tools"}),
    ...
    awful.key({modkey,},"t",function() awful.util.spawn("telegram-desktop") end,
    	      {descritpion = "Launch Telegram",group = "Applications"}),
...
-- Ranger
    awful.key({ modkey },"-", function() awful.util.spawn("alacritty -e ranger") end,
              {description = "Open Ranger", group = "Applications"}),
    awful.key({ modkey },"o", function() awful.spawn("alacritty -e /home/nico/Notion/Notion") end,
              {description = "Open Notion", group = "Applications"})
